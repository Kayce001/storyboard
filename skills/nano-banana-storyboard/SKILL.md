...
description: 当用户提供一份中文文案或文本文件，例如 1.txt，希望把它拆成多张可用于 Nano Banana 生图的分镜输入时使用。此 skill 负责判断需要生成几张图、每张图的镜头作用、风格模板、画面元素、中英文提示词、负面提示词，以及每张图对应的标准知识句。适用于“帮我写 Nano Banana 提示词”“把文案拆成图片分镜”“给我多张图的生图输入”“做成剪映式图片分镜视频”等请求。
version: 0.2.0
---

...
usage() {
  cat <<'EOF'
Usage:
  bash scripts/run_make_video_plus_wsl.sh <task-id|input-file> [extra args...]

Examples:
  bash scripts/run_make_video_plus_wsl.sh 10
  bash scripts/run_make_video_plus_wsl.sh tasks_plus/10/10.txt
EOF
}

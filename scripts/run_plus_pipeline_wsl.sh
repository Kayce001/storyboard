...
usage() {
  cat <<'EOF'
Usage:
  bash scripts/run_plus_pipeline_wsl.sh <task-id|input-file> [extra args...]

Examples:
  bash scripts/run_plus_pipeline_wsl.sh 10
  bash scripts/run_plus_pipeline_wsl.sh tasks_plus/10/10.txt
EOF
}
...
python "${PROJECT_ROOT}/scripts/run_plus_pipeline.py" \
